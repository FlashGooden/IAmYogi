...
import { NavigationLinks } from "./NavigationHamburgerLinks";
...
export function NavigationHamburger() {
  ...
  return (
    <nav id="nav">
      <div
        className={`absolute flex bg-transparent top-0 right-6 mt-8 mb-2 z-20 justify-between mr-3 ml-3 text-white`}
      >
        <FadeAndScale>
          <>
            <button
